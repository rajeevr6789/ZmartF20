...
<html lang="en">
  <head>
	...
	<!--Custom-->
	<link href="../../assets/css/small_box.css" rel="stylesheet">
    <!-- Bootstrap -->
	...
	<!-- Custom script -->
	<script language="javascript" type="text/javascript" src="../../assets/payloads/dataplot_jsp.jsp"></script>
	<script language="javascript" type="text/javascript" src="../../assets/payloads/dataplot_jsp_flot.jsp"></script>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="../../assets/images/Logo.jpg" alt="">Smart User
...
<table>
	...
	<script src="../../assets/payloads/jquery.flot.js"></script>
	<script src="../../assets/payloads/jquery.flot.resize.js"></script>
